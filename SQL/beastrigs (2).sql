...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2019 at 03:16 PM
...
('EB-I5-8GB-1TB-1050', '321545', 5, 55, 55, 3, '3', 'ATX', 'yes', 'aluminium', 'yes', 'yes', '123', 21, 2, 107, 0, '71tneCfSAPL._SR500,500_.jpg', '', '', 'Gaming PC', 'Cooler Master MasterBox K501L RGB Mid Tower Gaming Cabinet with Pre-installed Fans and Transparent Side Panel', 'Play your favorite games Crazy Games Like Dota 2, Shadow of Mordor, Battlefield , Star Wars BattleFront, Far Cry Primal, GTA V, FIFA , PUBG etc\r\nSystem: Intel Core i5 | 8GB DDR3 RAM | 1TB HDD | DOS | NVIDIA 1050ti 4GB Video Card | WIFI | HDMI Cable\r\nPC is', 5000),
...
(4, 'Anshul Chaudhary', '2017.anshul.chaudhary@ves.ac.in', '$2y$10$Ji51PLdwMnrRa6U72UEsGeDd.yRboGGi.Xd5kPEhosJEMcSjpQncC', 'SCwpVWi82513qgDdfSm72eOaK6jJ3oTV4pa67JD5QZdPP0Y9fVJR5ENO4jt7', '2019-10-19 21:57:05', '2019-10-19 21:57:05'),
...
--
ALTER TABLE `offers`
  ADD CONSTRAINT `offers_ibfk_1` FOREIGN KEY (`categoryId`) REFERENCES `productcategory` (`categoryId`),
  ADD CONSTRAINT `offers_ibfk_2` FOREIGN KEY (`categoryId`) REFERENCES `productcategory` (`categoryId`);
